...
//`--------------------------------------------------------------------------------------------------------------`
	...
	KC_LSFT, KC_NO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, RSFT_TD,  KC_UP,
	KC_LCTL, KC_LOPT, KC_LCMD, KC_NO,              KC_SPC,             KC_NO, TD(RCMD_OSL),TD(ROPT_OSL),OSL_FNSYM,SP_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
    ),
//  [WIN_BASE]
//,--------------------------------------------------------------------------------------------------------------,
//:  ____   ______________________   ______________________   ______________________    ____   ________________  :
...
//: | `  || 1  || 2  || 3  || 4  || 5  || 6  || 7  || 8  || 9  || 0  || -  || =  || Bkspace | |Ins ||Home||PgUp| :
//: |____||____||____||____||____||____||____||____||____||____||____||____||____||_________| |____||____||____| :
//: |LT(Tab)|| Q  || W  || E  || R  || T  || Y  || U  || I  || O  || P  || [  || ]  ||DYN_LT| |Del ||End ||PgDn| :
//: |_______||____||____||____||____||____||____||____||____||____||____||____||____||______| |____||____||____| :
//: |TD(Caps)|| A  || S  || D  || F  || G  || H  || J  || K  || L  || ;  || '  || Enter     |                    :
//: |________||____||____||____||____||____||____||____||____||____||____||____||___________|        ____        :
//: | Shift     || Z  || X  || C  || V  || B  || N  || M  || ,  || .  || /  || RSFT_TD      |       |Up  |       :
//: |___________||____||____||____||____||____||____||____||____||____||____||______________|  ____ |____| ____  :
//: |LCtrl||TLGUI||LAlt ||                Space                ||TRAlt||RWin ||TDFn ||SRCtrl| |Left||Down||Rigt| :
//: |_____||_____||_____||_____________________________________||_____||_____||_____||______| |____||____||____| :
//`--------------------------------------------------------------------------------------------------------------`
	...
	KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, BSPCFAST, KC_INS, KC_HOME, KC_PGUP,
	LT(TMUX_LAYR,KC_TAB), KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_RBRC, DYN_LT, KC_DEL, KC_END, KC_PGDN,
	TD(CAPS_LAYR), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_NO, KC_ENT,
	KC_LSFT, KC_NO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, RSFT_TD,  KC_UP,
	KC_LCTL, TD(LGUI_OSL), KC_LALT, KC_NO,           KC_SPC,          KC_NO, TD(RALT_OSL),KC_RWIN,OSL_FNSYM,SP_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
    ),
//  [CLCK_LAYR]
//,--------------------------------------------------------------------------------------------------------------,
//:  ____   ______________________   ______________________   ______________________    ____   ________________  :
...
//`--------------------------------------------------------------------------------------------------------------`
	...
	_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, WM_TIME, ARROW, WAVE, _______, LLOCK, V_TAB_PRV, V_WSPC_PRV,
...
//: |____| |____||____||____||____| |____||____||____||____| |____||____||____||____|  |____| |____||____||____| :
//:  _______________________________________________________________________________________   ________________  :
//: |USB ||BT1 ||BT2 ||BT3 ||2.4G||    ||    ||    ||    ||    ||    ||    ||    ||         | |LLck||FJLi||RMo+| :
//: |____||____||____||____||____||____||____||____||____||____||____||____||____||_________| |____||____||____| :
//: |       ||    ||    ||    ||Rebt||    ||    ||    ||    ||    ||    ||    ||    ||      | |RgbR||HRLi||RMo-| :
//: |_______||____||____||____||____||____||____||____||____||____||____||____||____||______| |____||____||____| :
...
//`--------------------------------------------------------------------------------------------------------------`
    [KCTL_LAYR] = LAYOUT_ansi(
        ...
        KC_USB , KC_BT1, KC_BT2, KC_BT3, KC_2G4, _______, _______, _______, _______, _______, _______, _______, _______, _______, LLOCK, FJLIGHT, RGB_MOD,
        _______, _______, _______, _______, QK_RBT, _______, _______, _______, _______, _______, _______, _______, _______, _______, ENC_RGBPUSH, HROWLIGHT, RGB_RMOD,
        _______, _______, _______, _______, FLASH_KB, _______, _______, _______, _______, _______, KTRACK, FJLIGHT, _______, HROWLIGHT,
        _______, _______, _______, _______, EE_CLR, _______, BOOTLDR, _______, _______, _______, _______, _______, _______, RGB_VAI,
...
//`--------------------------------------------------------------------------------------------------------------`
    [MSYM_LAYR] = LAYOUT_ansi(
        ...
        _______,_______,_______, _______,       _______,      _______,  TD(SUP_CYCLE),_______,_______,_______, _______,_______,_______
    ),
//  [WSYM_LAYR]
//,--------------------------------------------------------------------------------------------------------------,
//:  ____   ______________________   ______________________   ______________________    ____   ________________  :
